...
import com.nicoleneza.template.v1.exceptions.AppException;
...
import com.nicoleneza.template.v1.security.jwt.JwtUtils;
import com.nicoleneza.template.v1.security.user.UserPrincipal;
...
import com.nicoleneza.template.v1.utils.Mapper;
import com.nicoleneza.template.v1.utils.UserUtils;
...
public class AuthenticationServiceImpl implements IAuthService {
    ...
    private AuthResponse generateJwtAuthenticationResponse(Authentication authentication) {
        ...
        Employee user = userService.findUserById(userPrincipal.getId());
    ...
    public void forgotPassword(String email) {
        Employee user = userRepository.findUserByEmail(email).orElseThrow(
    ...
    public void verifyAccount(String verificationCode) {
        Employee user = userRepository.findByVerificationCode(verificationCode).orElseThrow(
